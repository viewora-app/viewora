            ...
            html += `
                <div class="notif-card">
                    ...
                    <div class="notif-content">
                        <strong>${notif.fromName || 'Someone'}</strong> ${notif.message || 'interacted with your post'}
